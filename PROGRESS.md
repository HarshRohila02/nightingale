...
**Last updated:** 2026-09-24 · by Claude (2a ✅, EXP-005; the `docs/05` amendment 3 proposal is in `docs/proposals/` for the team) · **Last verified commit:** `a75b270`
...
| CI (GitHub Actions) | ✅ green on every push so far (latest verified: `a75b270`, 2026-09-23: 346 passed, 27 skipped — CI has no `data/` or `models/`, so the data-gated tests skip) · Python 3.11 · since 2026-09-19 the job also starts a throwaway `neo4j:5-community` container for the live Neo4j tests |
