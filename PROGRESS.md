...
**Last updated:** 2026-09-25 · by Claude (amendment 3 applied; EXP-019 scored on its masks: the original B1 misses the safety targets at 25%, the `+aug` models meet them; the configured ranker is now B1-LR′+aug; A-7 settled) · **Last verified commit:** `b8c595a`
