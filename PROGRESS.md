...
**Last updated:** 2026-09-24 · by Claude (2a ✅, EXP-005; the `docs/05` amendment 3 proposal is in `docs/proposals/` for the team) · **Last verified commit:** `51169f5`
...
| **Health** | 401 tests (373 + 27 for the graph score + 1 property test; GC-001's strict xfail is now a plain assertion). Locally 392 pass and the 9 live Neo4j tests skip unless `NEO4J_TEST_DOTENV=1` (with it all 9 passed against Aura on 2026-09-19) · **CI green on GitHub at `51169f5`**: 368 passed, 33 skipped (CI has no `data/` or `models/`) · the Colab-trained B0/B1 models reproduce their validate metrics to within 3 × 10⁻¹² |
