...
**Last updated:** 2026-09-25 · by Claude (2d ✅, EXP-008; EXP-018 evaluated: the retrained B1 no longer answers AF to short input) · **Last verified commit:** `9986024`
...
- **R-18, the "asked" channel** (the deep-ranker plan's R2) · code ✅ 2026-09-24; retrain on **Colab**
  ...
  on short input; masked validate waits for amendment 3 — → pending. `EvidenceEncoder(asked_channel=True)`: `E_nn=unasked`
...
| CI (GitHub Actions) | ✅ green on every push so far (latest verified: `4583e91`, 2026-09-24: 561 passed, 37 skipped — CI has no `data/` or `models/`, so the data-gated tests skip) · Python 3.11 · since 2026-09-19 the job also starts a throwaway `neo4j:5-community` container for the live Neo4j tests |
